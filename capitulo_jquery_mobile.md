...
El objetivo principal de este framework es conseguir una misma sensación de navegación por parte del usuario final en la mayoría de los dispositivos móviles. Por otro lado, si pensamos en el desarrollador, jQuery Mobile pretende que éste se centre en las características del producto y no tanto en el dispositivo móvil al que va dirigido tomando como suya la frase _"write less, do more"_ (escribe menos, consigue más).

![Dispositivos funcionando con jQuery Mobile](images/web_jqm/jquery-mobile-devices-beta.png "Dispositivos funcionando con jQuery Mobile")
