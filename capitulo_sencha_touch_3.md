...
En el siguiente ejemplo se puede ver como definir un _proxy_ directamente en el modelo (las opciones de configuración son exactamente las mismas que si lo hiciéramos en el _store_):
